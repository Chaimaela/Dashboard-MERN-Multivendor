...
const OrderDetails = () => {
    ...
    return (
        ...
        <div className='w-full p-4 bg-black rounded-md'>
            <div className='flex justify-between items-center p-4'>
                ...
                <select onChange={status_update} value={status} name="" id="" className='px-4 py-2 focus:border-slate-500 outline-none bg-[#475569] border border-slate-700 rounded-md text-[#d0d2d6]'>
        ...
        <div className='p-4'>
                    ...
                    <div className='pr-3 text-[#d0d2d6] text-lg'>
                        <div className='flex flex-col gap-1'>
                            ...
                            <span className=' flex flex-col text-sm  '>
                               ...
                               <p> Area : {order.shippingInfo?.area}</p>   </span>
                        </div>
            ...
            <div className='mt-4 flex flex-col gap-4 bg-[#585757] rounded-md'>
                <div className='text-[#d0d2d6]'>
    {
        order.products && order.products.map((p, i) =>  <div key={i} className='flex gap-3 '>
    ...
    <div className='w-[70%]'>
        <div className='pl-3'>
            <div className='mt-4 flex flex-col bg-[#585757] rounded-md p-4'>
