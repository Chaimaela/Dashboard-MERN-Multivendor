...
const ChatSeller = () => {
    ...
    <div className='w-full md:w-[calc(100%-200px)] md:pl-4'>
        ...
        <div ref={scrollRef} className='w-full flex justify-start items-center'>
                ...
                }) : <div className='w-full h-full flex justify-center items-center flex-col gap-2 text-gray-500'>
        ...
        <form onSubmit={send} className='flex gap-3'>
            ...
            <button disabled={sellerId ? false : true} className='shadow-lg bg-gray-500 hover:shadow-gray-500/50 text-semibold w-[75px] h-[35px] rounded-md text-white flex justify-center items-center'>Send</button>
