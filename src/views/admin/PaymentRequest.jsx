...
const PaymentRequest = () => {
    ...
    const Row = ({ index, style }) => {
        ...
        <div className='w-[25%] p-2 whitespace-nowrap'>
            ...
            <button disabled={loader} onClick={() => confirm_request(pendingWithdrows[index]?._id)} className='bg-slate-500 shadow-lg hover:shadow-slate-500/50 px-3 py-[2px cursor-pointer text-white rounded-sm text-sm]'>{(loader && paymentId === pendingWithdrows[index]?._id) ? 'loading..' : 'Confirm'}</button>
        </div>
    ...
    <div className='w-full p-4 bg-[#1d1c22] rounded-md'>
        ...
        <div className='w-full'>
            <div className='w-full overflow-x-auto'>
                <div className='flex bg-[#fff] uppercase text-xs font-bold min-w-[340px] rounded-md'>
