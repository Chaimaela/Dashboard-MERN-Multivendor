...
const AdminDashboard = () => {
    ...
    return (
        ...
        <div className='w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0'>
            <div className='w-full  p-4 rounded-md text-[#d0d2d6]'>
                <div className='flex justify-between items-center'>
                    <h2 className='font-semibold text-lg text-gray-500 pb-3'>Recent Seller Message</h2>
        ...
        <div className='flex flex-col gap-2 pt-6 text-white'>
            ...
            <time className='mb-1 text-sm font-normal sm:order-last sm:mb-0'> {moment(m.createdAt).startOf('hour').fromNow()}</time>
                ...
                <div className='p-2 text-xs font-normal bg-[#36343d] rounded-lg border border-slate-800'>
                    {m.message}
                </div>
                </div>
            </li>)
    ...
    <table className='w-full text-sm text-left text-white'>
        <thead className='text-sm text-[#ffff] uppercase border-b border-white-200'>
        <tr>
