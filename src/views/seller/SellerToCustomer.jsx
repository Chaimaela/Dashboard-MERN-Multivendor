...
const SellerToCustomer = () => {
    ...
    <div className='  px-2 lg:px-7 py-5'>
        <div className='w-full bg-[#1d1c22] px-4 py-4 rounded-md h-[calc(100vh-140px)]'>
    ...
    <div className={`w-[280px] h-full absolute z-10 ${show ? '-left-[16px]' : '-left-[336px]'} md:left-0 md:relative transition-all `}>
        ...
        <div className='flex text-xl justify-between items-center p-4 md:p-0 md:px-3 md:pb-3 text-white font-bold'>
        <h2>Customers</h2>
    ...
    <div className=' w-full md:w-[calc(100%-200px)] md:pl-4'>
        ...
        <div className='py-4'>
            <div className='bg-[#dbdbdb] h-[calc(100vh-290px)] rounded-md p-3 overflow-y-auto'>
           
    {
        ...
        }) : <div className='w-full h-full flex justify-center items-center text-gray-500 gap-2 flex-col'>
        ...
        <form onSubmit={send} className='flex gap-3'>
            <input value={text} onChange={(e) => setText(e.target.value)} className='w-full flex justify-between px-2 border border-slate-500 items-center py-[5px] focus:border-blue-500 rounded-md outline-none bg-transparent text-[#d0d2d6]' type="text" placeholder='Input Your Message' />
            <button className='shadow-lg bg-gray-500 hover:shadow-gray-600/50 text-semibold w-[75px] h-[35px] rounded-md text-white flex justify-center items-center'>Send</button>
