...
const Orders = () => {
    ...
    return (
        <div className='  px-2 lg:px-7 pt-5'>
            <h1 className='text-gray-600 font-semibold text-xl mb-3'>Orders</h1>
    ...
    <table className='w-full text-sm text-left text-white'>
        <thead className='text-sm text-white uppercase border-b border-gray-500'>
        <tr>
        ...
        <tbody>
            {
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                    ...
                    <Link to={`/seller/dashboard/order/details/${d._id}`} className='p-[6px] text-gray-600 bg-gray-100 rounded hover:shadow-lg hover:shadow-green-500/50'> <FaEye/> </Link>
