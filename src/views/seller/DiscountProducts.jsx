...
const DiscountProducts = () => {
    ...
    return (
        <div className='  px-2 lg:px-7 pt-5'>
            <h1 className='text-gray-600 font-semibold text-lg mb-3'>Discount Products</h1>
        ...
        <tbody>
            {
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                    ...
                    <Link className='p-[6px] bg-white  text-yellow-400 rounded hover:shadow-lg hover:shadow-gray-500/50'> <FaEdit/> </Link> 
                    <Link className='p-[6px]  bg-white text-gray-600 rounded hover:shadow-lg hover:shadow-gray-500/50'> <FaEye/> </Link>
                    <Link className='p-[6px] bg-white text-red-500 rounded hover:shadow-lg hover:shadow-red-500/50'> <FaTrash/> </Link> 
                    </div>
