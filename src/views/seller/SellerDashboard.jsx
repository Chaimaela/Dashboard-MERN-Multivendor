...
const SellerDashboard = () => {
    ...
    const checkAccessToken = () => {
      ...
      // Call the function before the page shows up
      checkAccessToken();
    ...
    return (
        <div className='  px-2 md:px-7 py-5'>
            ...
            <div className='  w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7'>
                ...
                <div className='flex justify-between items-center p-5 bg-[#f0f4ff] rounded-md gap-3'>
                    ...
                    <MdProductionQuantityLimits  className='text-[#000] ' /> 
                    </div> 
                </div>
        ...
        <div className='w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0'>
            <div className='w-full  p-4 rounded-md text-[#000]'>
                <div className='flex justify-between items-center'>
                    <h2 className='font-semibold text-lg text-gray-500 pb-3'>Recent Customer Message</h2>
                    <Link className='font-semibold text-sm text-gray-500'>View All</Link>
                </div>

        <div className='flex flex-col gap-2 pt-6 '>
            <ol className='relative border-1 border-slate-600 ml-4 text-gray-500'>
               
    {
        recentMessage.map((m, i) => <li className='mb-3 ml-6 text-gray-500'>
        ...
        <div className='p-3 bg-[#1d1c22] rounded-lg border border-slate-600 shadow-sm'>
    ...
    <time className='mb-1 text-sm font-normal sm:order-last sm:mb-0'> {moment(m.createdAt).startOf('hour').fromNow()}</time>
        ...
        <div className='p-2 text-xs font-normal bg-[#f1efe3] rounded-lg border border-slate-800'>
            {m.message}
        </div>
        </div>
    </li>)
        ...
        <div className='w-full p-4 bg-[#1d1c22] rounded-md mt-6'>
            <div className='flex justify-between items-center'>
                <h2 className='font-semibold text-lg text-gray-100 pb-3  font-bold'>Recent Orders</h2>
                <Link className='font-semibold text-sm text-gray-200 font-bold'>View All</Link>
               </div>

    <div className='relative overflow-x-auto'>
    <table className='w-full text-sm text-left text-white'>
        <thead className='text-sm text-gray-200 uppercase border-b border-white'>
        <tr>
