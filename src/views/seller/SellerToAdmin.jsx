...
const SellerToAdmin = () => {
    ...
    <div className='w-full md:pl-4'>
        ...
        <h2 className='text-base text-gray-500 font-bold'>Support</h2>
        ...
        <div className='py-4'>
            <div className='bg-[#e5dfd0] h-[calc(100vh-290px)] rounded-md p-3 overflow-y-auto'>
...
<div ref={scrollRef} key={i} className='w-full flex justify-start items-center'>
        ...
        <form onSubmit={send}  className='flex gap-3'>
            ...
            <button className='shadow-lg bg-gray-500 hover:shadow-gray-500/50 text-semibold w-[75px] h-[35px] rounded-md text-white flex justify-center items-center'>Send</button>
